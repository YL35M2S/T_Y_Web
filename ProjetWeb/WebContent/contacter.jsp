...
<body class="cbp-spmenu-push">
    ...
    <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
        <h3>Menu</h3>
        <a href="Bonjour.jsp"><i class="fa fa-home fa-3x"></i>ACCUEIL</a>
        <a href="Videos.jsp"><i class="fa fa-microphone fa-3x"></i>VIDEO</a>
        <a href="Photos.jsp"><i class="fa fa-dollar fa-3x"></i>PHOTOS</a>
        <a href="Musiques.jsp"><i class="fa fa-rocket fa-3x"></i>MUSIQUES</a>
        <a href="contacter.jsp"><i class="fa fa-globe fa-3x"></i>CONTACT</a>
    </nav>
    ...
    <div class="container" id="home">
        <div class="row text-center">
            <div class="col-md-12">
                <h2 class="head-sub-main">Nous contacter</h2>
    ...
    <div class="for-full-back color-bg-one" id="footer">
        2017 | Master CCI | Projet Web |Yoann Lespert et Th̩o Perrin
